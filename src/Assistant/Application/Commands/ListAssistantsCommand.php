...
use Assistant\Application\CommandHandlers\ListAssistantsCommandHandler;
...
#[Handler(ListAssistantsCommandHandler::class)]
class ListAssistantsCommand extends CountAssistantsCommand
{
